...
public class SelectAllOracle {
	public static void main(String[] args) {
		...
		try {
			Class.forName(driver);	// 1. 드라이버 로드(jdk17부터는 생략가능)
